// Branding
export { default as logo } from "./sris-logo-only.png";
export { default as srisBrandLogo } from "./sris-brand-logo.png";
export { default as srisNameMark } from "./sris-name-mark.png";

// Hero
export { default as heroBeautyIllustration } from "./hero-beauty-illustration.png";

// Team portraits
export { default as jamunaPortrait } from "./jamuna-portrait.png";
export { default as vigneshPortrait } from "./vignesh-portrait.png";
